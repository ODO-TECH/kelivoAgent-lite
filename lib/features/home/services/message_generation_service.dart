...
import '../../../core/services/agent/kelivo_agent_prompt.dart';
...
class MessageGenerationService {
  ...
  String _agentSystemPrompt(
    ...
    final fallback = assistantPrompt?.trim();
    return fallback == null || fallback.isEmpty
        ? kelivoAgentSystemPrompt
        : fallback;
  }
