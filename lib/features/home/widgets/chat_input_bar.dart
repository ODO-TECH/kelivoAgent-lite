...
import 'agent_syntax_highlighting_controller.dart';
...
class ChatInputBar extends StatefulWidget {
  const ChatInputBar({
    ...
    this.showPromptOptimizeButton = false,
  ...
  final bool showPromptOptimizeButton;
...
class _ChatInputBarState extends State<ChatInputBar>
  ...
  void initState() {
    super.initState();
    _controller = widget.controller ?? AgentSyntaxHighlightingController();
  ...
  Widget _buildResponsiveLeftActions(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (widget.showPromptOptimizeButton &&
            widget.onOptimizePrompt != null) {
          actions.add(
            _OverflowAction(
              width: normalButtonW,
              builder: () => _CompactIconButton(
                ...
                icon: Lucide.WandSparkles,
                onTap: lockTap(widget.onOptimizePrompt),
              ),
              menu: DesktopContextMenuItem(
                icon: Lucide.WandSparkles,
