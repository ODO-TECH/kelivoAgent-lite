...
abstract class AppLocalizations {
  ...
  /// No description provided for @workspacesShell.
  ///
  /// In en, this message translates to:
  /// **'Shell'**
  String get workspacesShell;

  /// No description provided for @workspacesShellPowerShell.
  ///
  /// In en, this message translates to:
  /// **'PowerShell'**
  String get workspacesShellPowerShell;

  /// No description provided for @workspacesShellCommandPrompt.
  ///
  /// In en, this message translates to:
  /// **'Command Prompt'**
  String get workspacesShellCommandPrompt;

  /// No description provided for @workspacesShellGitBash.
  ///
  /// In en, this message translates to:
  /// **'Git Bash'**
  String get workspacesShellGitBash;

  /// No description provided for @workspacesShellCustom.
  ///
  /// In en, this message translates to:
  /// **'Custom executable'**
  String get workspacesShellCustom;

  /// No description provided for @workspacesShellPathHint.
  ///
  /// In en, this message translates to:
  /// **'Optional for Git Bash; required for custom'**
  String get workspacesShellPathHint;
